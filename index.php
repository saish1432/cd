            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo $image_url; ?>" alt="<?php echo $product['name']; ?>" class="zoomable">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price">
                            <?php if($product['market_price'] > $product['price']): ?>
                                <span class="market-price">₹<?php echo $product['market_price']; ?></span>
                            <?php endif; ?>
                            <span class="current-price">₹<?php echo $product['price']; ?></span>
                        </div>
                        <div class="product-actions">
                            <button class="inquiry-btn" onclick="inquireProduct('<?php echo $product['name']; ?>')">
                                <i class="fab fa-whatsapp"></i> Inquiry Now
                            </button>
                            <button class="cart-btn" onclick="addToCart(<?php echo $product['id']; ?>, '<?php echo $product['name']; ?>', <?php echo $product['price']; ?>)">
            ...
            <div class="categories-grid">
                ...
                <div class="category-card animated-category">
                    <div class="category-image">
                        <img src="<?php echo $cat_image_url; ?>" alt="<?php echo $category['name']; ?>">
                    </div>
            ...
            <div class="accessories-grid">
                ...
                <div class="accessory-card">
                    <div class="accessory-images">
                        <img src="<?php echo $acc_image_url; ?>" alt="<?php echo $accessory['name']; ?>" class="image-flip active">
                        <img src="<?php echo $acc_image_url2; ?>" alt="<?php echo $accessory['name']; ?>" class="image-flip">
                    </div>
                    <div class="accessory-info">
                        <h3><?php echo $accessory['name']; ?></h3>
                        <p><?php echo $accessory['description']; ?></p>
                        <div class="accessory-price">₹<?php echo $accessory['price']; ?></div>
                        <button class="buy-btn" onclick="buyNow(<?php echo $accessory['id']; ?>, '<?php echo $accessory['name']; ?>', <?php echo $accessory['price']; ?>)">
            ...
            <div class="most-selling-grid">
                ...
                <div class="selling-card">
                    <div class="selling-image">
                        <img src="<?php echo $ms_image_url; ?>" alt="<?php echo $product['name']; ?>" class="zoomable">
                    </div>
                    <div class="selling-info">
                        ...
                        <div class="price-box">
                            ...
                            <div class="market-price-box">
                                ...
                                <span>₹<?php echo $product['market_price']; ?></span>
                            </div>
                            <?php endif; ?>
                        ...
                        <button class="buy-now-btn" onclick="addToCartAndShow(<?php echo $product['id']; ?>, '<?php echo $product['name']; ?>', <?php echo $product['price']; ?>)">
